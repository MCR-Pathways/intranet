...
const USER_TABLE_SELECT =
  "id, full_name, preferred_name, email, user_type, status, is_hr_admin, is_ld_admin, is_systems_admin, is_content_editor, is_line_manager, can_post_announcements, job_title, avatar_url, induction_completed_at, fte, department, region, contract_type, work_pattern, start_date, probation_end_date, contract_end_date, is_external, line_manager_id, team_id, created_at";

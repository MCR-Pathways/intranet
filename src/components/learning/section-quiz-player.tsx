 ...
 *
 * Security: is_correct is NOT sent to client — correct answers are
 * returned server-side only after submission.
 */
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-8">
        {questions.map((q, idx) => {
          ...
          const showReview = !!result && correctIds.length > 0;
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          ...
                          // After submission — correct answer review
                          showReview &&
                            isCorrectOption &&
                      ...
                      >
                        ...
                        {/* Pre-submission selection indicator */}
                        ...
                        {/* Post-submission correct/incorrect indicators */}
                        {showReview && isCorrectOption && (
                          <CheckCircle2 className="h-4 w-4 text-green-600" />
                        )}
                        {showReview && !isCorrectOption && isSelected && (

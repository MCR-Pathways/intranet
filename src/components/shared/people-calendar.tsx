  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <Button variant="outline" size="sm" onClick={prevMonth} type="button" aria-label="Previous month" title="Previous month">
          <ChevronLeft />
        </Button>
        ...
        <Button variant="outline" size="sm" onClick={nextMonth} type="button" aria-label="Next month" title="Next month">
          <ChevronRight />
        </Button>
      </div>

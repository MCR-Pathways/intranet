      ...
      <div className="grid gap-3 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        {topLevel.map((cat) => {
          ...
          return (
            <div
              key={cat.id}
              className="group/card relative rounded-xl border border-border bg-card overflow-hidden shadow-md transition-all hover:border-foreground/20 hover:shadow-md"
            >
              <Link

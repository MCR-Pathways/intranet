...
**Update documentation BEFORE implementing features, not after.** The colour overhaul lost context because docs were done post-implementation. Always update `docs/plan.md`, `docs/PROJECT.md`, `memory/MEMORY.md`, and `AGENTS.md` in a Phase 0 before writing any code.

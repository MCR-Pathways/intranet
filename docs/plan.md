...
- [ ] Expand test coverage (~18% currently — 38 test files, 903 tests / ~236 source files). Phases 0–6 complete (PRs #52, #53, #56, #57, #58, #61). Next: Phase 7 (hook tests). See [docs/testing-plan.md](./testing-plan.md).

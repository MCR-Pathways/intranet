...
- [ ] Expand test coverage (~14% currently — 28 test files, 757 tests / ~236 source files). Phase 0–4 complete (PRs #52, #53, #56, #57). Next: Phase 5 (component tests — news feed). See [docs/testing-plan.md](./testing-plan.md).

...
- [ ] Table standardisation (IN PROGRESS — 13 of 17 tables done, 6 PRs): Shadcn Table primitives + TanStack Table (`@tanstack/react-table`). Interactive sorting, pagination, sticky headers, row numbering. 17 tables across HR (13), Sign-In (2), Learning (2). Foundation PR #92 (merged). Profile tabs PR #93 (merged). HR dashboards PR #94 (merged). HR workflows PR #95 (merged). HR admin PR #96 (open). Remaining: sign-in+learning (4 tables). Research: 10 platforms studied. See `memory/table-standardisation.md`.
